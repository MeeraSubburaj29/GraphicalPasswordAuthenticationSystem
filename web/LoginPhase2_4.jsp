...
<html lang="en">
	...
	document.getElementById("image4").style.left = (pos_x-1) ;
	document.getElementById("image4").style.top = (pos_y-15) ;
	...
	//document.getElementById("y1").value = pos_y;
                document.form1.x4.value = pos_x;
	document.form1.y4.value = pos_y;
            }
                                ...
                                <main class="form-signin w-150 m-auto">
                                    ...
                                    <%
                                        ...
                                        if(rs.next()){
                                            ...
                                            session.setAttribute("Image4", imageName);
                                        }
                                        rs.close();
                                        ps.close();
                                    %>
                                    <form name="form1" method="post" action="LoginPhase2_4.jsp">

                                        <h1 class="h3 mb-3 fw-normal" style="font-size: 25px;font-weight: bold;">
                                            Phase2 Login
                                        </h1>
                                        <h2>
                                            (Image Click Point-Image4)
                                        </h2>
                                        <h5>
                                           One Click Point on Image
                                        </h5>                                        
                                        <img id="image4" name="image4" src="${sessionScope.UserId}/<%=imageName%>" onclick="getImagePosition(event);" />
                                        <input type="hidden" name="x4" style="width: 65px;"/>
                                        <input type="hidden" name="y4" style="width: 65px;"/>
                                        ...
                                        <%
                                            if(request.getParameter("s1")!=null){
                                                x = Integer.parseInt(request.getParameter("x4"));
                                                y = Integer.parseInt(request.getParameter("y4"));
                                                session.setAttribute("Image4_X", x);
                                                session.setAttribute("Image4_Y", y);
            
                                                response.sendRedirect("LoginPhase2_5.jsp");
                                            }
                                        %>
                                </main>
                            </div>
