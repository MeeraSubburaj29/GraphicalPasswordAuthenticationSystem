                        ...
                        <div class="article">
                            ...
                            <div style="width:550px; margin-left: 450px;">
                                <main class="form-signin w-150 m-auto">
                                    <form name="form1" method="post" action="RegistrationPhase2_Process1.jsp" enctype="multipart/form-data">
                                        ...
                                        <h5>
                                            Select an Image and One Click Point on Image
                                        </h5>
                                        <input type="file" accept="image/*" id="file1" name="file1" onchange="loadFile(event);" />
                                        <img id="image1" name="image1" onclick="getImagePosition(event);" />
                                        <input type="hidden" name="x1" style="width: 65px;"/>
                                        <input type="hidden" name="y1" style="width: 65px;"/>
                                        <button class="w-100 btn btn-lg btn-primary" type="submit">Goto Next Image</button>
                                    </form>
                                </main>
                            </div>
                        </div>     
